...
$(document).ready(function () {
	...
	var dirtyHtmlString = $('div.dirty_html_source').html();

	var dirtyHtmlString2 = '<div class="modalWrap modal_kbd show"><div class="modalHeading"><h3 style="cursor: move;">Keyboard shortcuts</h3><span class="close">Close window</span></div><div id="kbd" class="modalBody"><ul><li><kbd>CTRL</kbd> + <kbd>Return</kbd> <span>Run fiddle</span></li><li><kbd>CTRL</kbd> + <kbd>S</kbd> <span>Save fiddle (Save or Update)</span></li><li><kbd>CTRL</kbd> + <kbd>Shift</kbd> + <kbd>Return</kbd> <span>Load draft</span></li><li><kbd>CTRL</kbd> + <kbd>Shift</kbd> + <kbd>↑</kbd> <span>Toggle sidebar</span></li></ul></div></div>';

	$('#beautify').on('click', function () {
		console.log('test');

		var beautified_html_source = style_html(dirtyHtmlString, {
			'indent_size': 2,
			'indent_char': ' ',
			'max_char': 78,
			'brace_style': 'expand',
		...
		alert(beautified_html_source);

		$('div.beautified_html_source').html(beautified_html_source);
	});
